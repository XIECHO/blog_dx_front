  ...
  <div class="comment-part">
    ...
    <div class="comment-content">
      <div class="content-userName">
        {{ comment.user || "用户名好像不见了" }}
      </div>
      <div class="content-content">
        <span v-if="comment.follow_user"
          >回复 <span class="content-userName">{{ comment.follow_user }}</span
          >：</span
        >
      ...
      <div class="content-info">
        ...
        <button
          v-if="isRemoveShow"
          class="comment-btn"
          @click="removeCommentClick(comment._id, topCommentId)"
        >
...
import { RemoveFollowComment, RemoveComment } from "@/api/comment";
