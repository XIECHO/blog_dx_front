<template>
  <div class="about">
    ...
    <div class="about-part clearfix">
      <span class="part-title">简介</span>
      <div class="path-info">
        <div class="info-item">
          “自有林中趣，谁惊岁去频”出自唐代无可的《新年》，开始敲这个博客是在18年年末，当时的确很应景。但我个人还有另外一层理解，转行这些时间，因为年龄，因为过往经历，的确给我带来了很多困境。我想通过这句话告诉自己：无论外界的环境是什么样子的，过往已无法改变，只有保留内心的‘林中趣’，做好当下的事情才是最重要的。
        </div>
        <div class="info-item">
          更多请见这篇文章
    ...
    <div class="about-part clearfix">
      ...
      <div class="path-info">
        <div class="info-item">
          最初版模仿自博客<a href="https://zhwangart.github.io/" target="_blank"
            >数学家</a
          >，非常喜欢这套主题
        </div>
      </div>
    ...
    <div class="about-part clearfix">
      ...
      <div class="path-info">
        <div class="info-item">
          <a href="https://github.com/wuyuanaaa/vue-blog" target="_blank"
            >github 仓库地址</a
          >
        </div>
      </div>
    ...
    <div class="about-part clearfix">
      ...
      <div class="path-info">
        <div class="info-item">详见上方 github 仓库 README</div>
      </div>
    </div>
    <div class="about-part clearfix">
      <span class="part-title">技术栈</span>
      <div class="path-info">
        <div class="info-item">前端：Vue Cli3、Vue Router、Vuex、iView ...</div>
        <div class="info-item">后端：Nodejs、Express、Mongoose ...</div>
        <div class="info-item">数据库：MongoDB</div>
      </div>
    </div>

    <div class="about-part clearfix">
      <span class="part-title">近期flag</span>
      <div class="path-info">
